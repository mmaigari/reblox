class ContactUsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @contact_u.save
        format.html { redirect_to contact_u_url(@contact_u), notice: "Contact u was successfully created." }
  ...
  def update
    respond_to do |format|
      if @contact_u.update(contact_u_params)
        format.html { redirect_to contact_u_url(@contact_u), notice: "Contact u was successfully updated." }

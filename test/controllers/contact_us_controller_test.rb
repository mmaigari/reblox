...
class ContactUsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_u" do
    assert_difference("ContactU.count") do
      post contact_us_url, params: { contact_u: { email: @contact_u.email, message: @contact_u.message, name: @contact_u.name } }
    end
  ...
  test "should update contact_u" do
    patch contact_u_url(@contact_u), params: { contact_u: { email: @contact_u.email, message: @contact_u.message, name: @contact_u.name } }
